...
import { DuoBadgeCheck, DuoBot, DuoEye, DuoKey, DuoMessageAlert, DuoNodes, DuoRadar, DuoTerminal } from "./duoicons.jsx";

const CASES = [
  {
    icon: <DuoMessageAlert />, tag: "The obvious one",
  ...
  {
    icon: <DuoTerminal />, tag: "Developers move fast",
  ...
  {
    icon: <DuoEye />, tag: "Your own AI overshares",
  ...
  {
    icon: <DuoBot />, tag: "Assistants that act",
  ...
  {
    icon: <DuoKey />, tag: "Credentials already loose",
  ...
  {
    icon: <DuoRadar />, tag: "Agents nobody is watching",
  ...
  {
    icon: <DuoNodes />, tag: "You ship AI yourself",
  ...
  {
    icon: <DuoBadgeCheck />, tag: "Someone asks for proof",
    ...
    <div className="landing">
      ...
      <section className="lp-section alt">
        <div className="lp-wrap">
          ...
          <Shot lead src="/shots/discovery.png?v=7" alt="Inventory of AI tools in use" />
        </div>
      </section>
