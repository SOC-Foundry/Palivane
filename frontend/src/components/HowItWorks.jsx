...
const DETECTORS = [
  ...
  { icon: <IconTarget />, title: "ML classifier", surface: "ai_usage · llm_io · collab", body: "A hashed n-gram model (trained on a labeled code/prose corpus; 96% accuracy, 97% precision held-out) catches the source-code boundary cases keyword rules read past — config fragments, minified snippets. CPU-only and deterministic, sub-millisecond, runs on-box: no model service in the loop. Alone it corroborates; agreeing with the rules check it escalates." },
