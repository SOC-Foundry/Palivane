...
const SELF = [
  ...
  { n: "3", title: "Finish the browser extension",
    body: "Install the Palivane extension from the Chrome Web Store (chromewebstore.google.com/detail/fnejondlaacijahdjkhcgiijlnjoapho — works on Chrome and Edge; managed fleets force-install the same listing by browser policy) then click 'Sign in to Palivane' in its popup to bind it to your org. Now claude.ai, ChatGPT, and Gemini are covered too." },
